...
public class FiltersAdapters extends RecyclerView.Adapter<FiltersAdapters.MyViewHolder> {
    ...
    public FiltersAdapters(Context context, List<ThumbnailItem> thumbnailItemList, ThumbnailsAdapterListener listener) {
        mContext = context;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.filters_list, parent, false);
